    ...
    auto format(couchbase::protocol::status opcode, FormatContext& ctx)
    {
        ...
        switch (opcode) {
            ...
            case couchbase::protocol::status::subdoc_xattr_cannot_modify_vattr:
                name = "subdoc_xattr_cannot_modify_vattr";
                break;
