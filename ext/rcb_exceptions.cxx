...
init_exceptions(VALUE mCouchbase)
{
    ...
    eNetworkRequestCanceled = rb_define_class_under(mError, "NetworkRequestCanceled", eCouchbaseError);
...
cb_map_error(const key_value_error_context& ctx, const std::string& message)
{
    ...
    rb_hash_aset(error_context, rb_id2sym(rb_intern("retry_attempts")), ULONG2NUM(ctx.retry_attempts()));
