        ...
        class GetBucketCommand
          ...
          def set_options
            ...
            builder = OptionsBuilder.new(
              options: Couchbase::Management::Options::Bucket::GetBucket.new,
              raw_options: @raw_options,
            )
            builder.set_timeout
          ...
          def execute_command
            Results.as_bucket_settings(initiated: @initiated, return_result: @return_result) do
              @manager.get_bucket(*@cmd_args)
            end
          end

          def self.create_command(...)
            cmd = GetBucketCommand.new(...)
            cmd.set_options
            cmd
          end
        end
