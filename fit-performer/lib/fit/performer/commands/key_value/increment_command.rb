      ...
      module KeyValue
        class IncrementCommand
          ...
          def set_options
            ...
            builder = OptionsBuilder.new(options: Couchbase::Options::Increment.new, raw_options: @raw_options)
            builder.set_timeout
                   .set_expiry
                   .set_delta
                   .set_initial
          ...
          def execute_command
            Results.as_counter_result(return_result: @return_result, initiated: @initiated) do
              @binary_collection.increment(*@cmd_args)
            end
          end

          def self.create_command(...)
            cmd = IncrementCommand.new(...)
            cmd.set_options
            cmd
          end
        end
