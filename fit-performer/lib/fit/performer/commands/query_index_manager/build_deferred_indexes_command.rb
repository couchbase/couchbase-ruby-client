  ...
  module Performer
    module Commands
      module QueryIndexManager
        class BuildDeferredIndexesCommand
          ...
          def set_options
            ...
            builder = OptionsBuilder.new(
              options: Couchbase::Management::Options::Query::BuildDeferredIndexes.new,
              raw_options: @raw_options,
            )
            builder.set_timeout
                   .set_scope_name
          ...
          def execute_command
            Results.as_success(initiated: @initiated) do
              @manager.build_deferred_indexes(*@cmd_args)
            end
          end

          def self.create_command(...)
            cmd = BuildDeferredIndexesCommand.new(...)
            cmd.set_options
            cmd
          end
        end
