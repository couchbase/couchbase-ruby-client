        ...
        class DropPrimaryIndexCommand
          ...
          def set_options
            ...
            builder = OptionsBuilder.new(
              options: Couchbase::Management::Options::Query::DropPrimaryIndex.new,
              raw_options: @raw_options,
            )
            builder.set_timeout
                   .set_collection_name
                   .set_scope_name
                   .set_ignore_if_does_not_exist
          ...
          def execute_command
            Results.as_success(initiated: @initiated) do
              @manager.drop_primary_index(*@cmd_args)
            end
          end

          def self.create_command(...)
            cmd = DropPrimaryIndexCommand.new(...)
            cmd.set_options
            cmd
          end
        end
