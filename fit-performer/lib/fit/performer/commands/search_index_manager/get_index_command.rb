        ...
        class GetIndexCommand
          ...
          def set_options
            ...
            builder = OptionsBuilder.new(
              options: Couchbase::Management::SearchIndexManager::GetIndexOptions.new,
              raw_options: @raw_options,
            )
            builder.set_timeout
          ...
          def execute_command
            Results.as_search_index(initiated: @initiated) do
              @manager.get_index(*@cmd_args)
            end
          end

          def self.create_command(...)
            cmd = GetIndexCommand.new(...)
            cmd.set_options
            cmd
          end
        end
