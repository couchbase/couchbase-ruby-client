  ...
  module Performer
    module Commands
      module SearchIndexManager
        class GetIndexedDocumentsCountCommand
          ...
          def set_options
            ...
            builder = OptionsBuilder.new(
              options: Couchbase::Management::SearchIndexManager::GetIndexedDocumentsCountOptions.new,
              raw_options: @raw_options,
            )
            builder.set_timeout
          ...
          def execute_command
            Results.as_indexed_documents_count(initiated: @initiated) do
              @manager.get_indexed_documents_count(*@cmd_args)
            end
          end

          def self.create_command(...)
            cmd = GetIndexedDocumentsCountCommand.new(...)
            cmd.set_options
            cmd
          end
        end
