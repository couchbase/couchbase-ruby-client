...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("couchbase/internal/hooks/v1/hooks.proto", :syntax => :proto3) do
    ...
    add_enum "couchbase.internal.hooks.v1.ComparisonOperator" do
      value :COMPARISON_OPERATOR_EQUAL, 0
      value :COMPARISON_OPERATOR_NOT_EQUAL, 1
      value :COMPARISON_OPERATOR_GREATER_THAN, 2
      value :COMPARISON_OPERATOR_GREATER_THAN_OR_EQUAL, 3
      value :COMPARISON_OPERATOR_LESS_THAN, 4
      value :COMPARISON_OPERATOR_LESS_THAN_OR_EQUAL, 5
    end
  end
end
