...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("couchbase/kv/v1/kv.proto", :syntax => :proto3) do
    ...
    add_enum "couchbase.kv.v1.LookupInRequest.Spec.Operation" do
      value :OPERATION_GET, 0
      value :OPERATION_EXISTS, 1
    ...
    add_enum "couchbase.kv.v1.MutateInRequest.Spec.Operation" do
      value :OPERATION_INSERT, 0
      value :OPERATION_UPSERT, 1
      value :OPERATION_REPLACE, 2
      value :OPERATION_REMOVE, 3
      value :OPERATION_ARRAY_APPEND, 4
      value :OPERATION_ARRAY_PREPEND, 5
      value :OPERATION_ARRAY_INSERT, 6
      value :OPERATION_ARRAY_ADD_UNIQUE, 7
      value :OPERATION_COUNTER, 8
    end
    add_message "couchbase.kv.v1.MutateInRequest.Flags" do
      proto3_optional :access_deleted, :bool, 1
    end
    add_enum "couchbase.kv.v1.MutateInRequest.StoreSemantic" do
      value :STORE_SEMANTIC_REPLACE, 0
      value :STORE_SEMANTIC_UPSERT, 1
      value :STORE_SEMANTIC_INSERT, 2
    end
